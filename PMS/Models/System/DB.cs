...
namespace Models
{
    ...
    public partial class DB
    {
        ...
        static public DataBase Main { get; } = new DataBase(Environment.CurrentDirectory, "MainDB");
        static public Collection GetCollection<T>() { return Main.GetCollection<T>(); }
    }
...
namespace Models
{
        ...
        where T: DataContext
    {
        ...
        {
            UpdateOrInsert(item.ObjectId, item);
        }
